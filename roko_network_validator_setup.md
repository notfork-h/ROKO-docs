...
### 7.1 Generate an Address (Polkadot.js)

1. Open [roko-explorer.nfork Apps](https://roko-explorer.ntfork.com/#/accounts/vanity)
2. Click **Accounts → Vanity generator** and follow the wizard.
...
1. Copy your private key from Polkadot.js.
...
## 9. Lock ROKO to pwROKO

In the EVM interface, go to **Lock & Mint**, select **ROKO → pwROKO**, and lock your tokens.
...
Back in the EVM interface, go to **Delegate**, choose your validator’s address, enter the amount, and confirm.
